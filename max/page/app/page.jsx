...
<style>{`*{box-sizing:border-box;-webkit-tap-highlight-color:transparent} input[type=range]{-webkit-appearance:none;appearance:none} input[type=range]::-webkit-slider-thumb{-webkit-appearance:none;width:22px;height:22px;border-radius:7px;background:${S.neon};box-shadow:0 0 12px ${S.neon}88;border:2px solid rgba(255,255,255,0.15)} textarea,input{font-family:inherit;-webkit-font-smoothing:antialiased;font-size:16px !important} textarea{resize:none;outline:none;border:none} @keyframes fadeUp{from{opacity:0;transform:translateY(14px)}to{opacity:1;transform:none}} @keyframes spin{to{transform:rotate(360deg)}} @keyframes pulse{0%,100%{opacity:0.45}50%{opacity:1}} @keyframes scan{0%{transform:translateY(-100%)}100%{transform:translateY(200vh)}} @keyframes sosPulse{0%,100%{box-shadow:0 0 0 0 rgba(255,77,109,0.6)}60%{box-shadow:0 0 0 12px rgba(255,77,109,0)}} @keyframes ripple{0%,100%{opacity:0.3}50%{opacity:0.8}} button{-webkit-tap-highlight-color:transparent;touch-action:manipulation} .scroll-area{overflow-y:auto;-webkit-overflow-scrolling:touch;overscroll-behavior:contain} ::-webkit-scrollbar{width:2px}::-webkit-scrollbar-thumb{background:${S.neonB};border-radius:2px}`}</style>
