...
Kein Fülltext.`, placeholder:"Text, Artikel, Recherche-Ergebnis hier einfügen…", }, { id:"entscheidung", label:"Entscheid", icon:"⊕", system:`Du bist ein nüchternes Entscheidungs-Tool.
Antworte in diesem Format:
...
Direkt. Kein Coaching.`, placeholder:"Welche Entscheidung steht an? Kontext beschreiben…", }, { id:"impuls", label:"Impuls", icon:"⚡", system:`Du bist ein Sofort-Interventions-Tool für akute Impulssituationen.
Antworte in diesem Format:
...
<style>{`*{box-sizing:border-box;-webkit-tap-highlight-color:transparent} input[type=range]{-webkit-appearance:none;appearance:none;cursor:pointer} input[type=range]::-webkit-slider-thumb{-webkit-appearance:none;width:18px;height:18px;border-radius:4px;background:${S.neon};box-shadow:0 0 10px ${S.neon}} textarea{resize:none;outline:none;border:none;font-family:inherit} @keyframes fadeUp{from{opacity:0;transform:translateY(14px)}to{opacity:1;transform:none}} @keyframes spin{to{transform:rotate(360deg)}} @keyframes pulse{0%,100%{opacity:0.5}50%{opacity:1}} @keyframes scanline{0%{transform:translateY(-100%)}100%{transform:translateY(200vh)}} ::-webkit-scrollbar{width:3px} ::-webkit-scrollbar-track{background:${S.bg}} ::-webkit-scrollbar-thumb{background:${S.neonBorder};border-radius:2px}`}</style>
